 ...
 * @author Salm
 */
public class NguonThuExpTheoNgay implements LogHandle {
    ...
    public LogHandleOutput handle(List<LogRecord> logs) {
        ...
        logs.forEach((r) -> {
            ...
            ThuChiRecord expRec = (ThuChiRecord) r;
            Data data = o.mkGet(expRec.getSource());
            data.merge(expRec.getDay(), expRec.getChange(),
                    Integer::sum);
        });
    ...
    public String getDescription() {
        return "Phân tích lượng thu exp theo từng nguồn theo từng ngày";
    }
